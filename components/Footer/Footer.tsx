        ...
        <div className={styles.row}>
            <div className={styles.logoandfollow}>
                ...
                <div className={styles.followbtns}>
                    <Image src="/linkedin.png" width={100} height={100} alt='linkedin' className={styles.btnlogo}/>
                    <Image src="/github.png" width={100} height={100} alt='linkedin' className={styles.btnlogo}/>
                </div>
            </div>
